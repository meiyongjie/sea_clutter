"""V2 PatchTST 模型入口 — 与 V1 相同的包装逻辑，配置由 config_amplitude 驱动"""
...
class Model(nn.Module):
    ...
    与 V1 完全相同的模型结构，所有改动在配置层面：
    - seq_len=128, patch_len=4, stride=2 → 更多 patch
    - d_model=128, e_layers=3 → 更大更深的 Transformer
    - dropout=0.2 → 更强正则化
    """
