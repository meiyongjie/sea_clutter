"""V2 GRU 训练 — 单步 + Teacher Forcing + 早停"""
import json
import os
...
def train(args, train_loader, val_loader, scaler):
    ...
    print(f"Training GRU+CrossAttention (SCPNet V2) on {args.device}")
...
if __name__ == "__main__":
    ...
    result_path = os.path.join(args.save_dir, "gru_attention_amplitude_v2_results.json")
    os.makedirs(args.save_dir, exist_ok=True)
